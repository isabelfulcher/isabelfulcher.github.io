...
\begin{etaremune}
	...
	% Planned Parenthood (4) - Minors Cost, Minors Qual, Opioid Use 
	
	% Cottrill, A.A., \textbf{Fulcher, I.R.}, Goldberg, A.B., Sabino, J., Fortin, J., \& Janiak, E. (2020) Time trends in Massachusetss adolescents' post-abortion contraceptive uptake.  
		
	% Rindos, N.B., \textbf{Fulcher, I.R.}, \& Donellan, N.M. (2020). Self-Reported Pain and Quality of Life Following Laparoscopic Excision of Endometriosis as Measured Using the Endometriosis Health Profile-30: A 5 Year Follow-Up Study. 
	
	%\textbf{Fulcher, I. R.}, Lareau, C., Shpitser, I., \& Tchetgen Tchetgen, E. J. (2021). Bayesian auto-g-computation of network causal effects: incarceration and infection in a high risk network. \\
...
%``Identification and estimation of indirect effects robust to unmeasured confounding" Society for Epidemiological Research, Boston, MA (June 2020). \\

%``Optimization of digital maternal health programs'' Willows Seminar, Harvard T.H. Chan School of Public Health, Boston, MA (April 2020). \\

%``Bayesian auto-g-computation of network causal effects: incarceration and infection in a high risk network.'' ENAR, Nashville, TN (March 2020). \\
